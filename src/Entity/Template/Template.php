...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Template\TemplateRepository")
...
class Template
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Template\Zone", mappedBy="template", orphanRemoval=true)
