...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Template\ZoneRepository")
...
class Zone
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Template\Template", inversedBy="zone")
     ...
     * @ORM\OneToMany(targetEntity="App\Entity\Template\Zone", mappedBy="parent")
     */
    private $children;

    /**
     * Many Zones(children) have One Zone(parent).
     * @ORM\ManyToOne(targetEntity="App\Entity\Template\Zone", inversedBy="children")
    ...
    {
        return $this->incruste_elements_id;
    }

    public function setContent(?array $incruste_elements_id): self
    {
        $this->incruste_elements_id = $incruste_elements_id;

        return $this;
    }

    public function getIncrusteElementsId(): ?array
    {
        return $this->incruste_elements_id;
    }

    public function setIncrusteElementsId(?array $incruste_elements_id): self
    {
        $this->incruste_elements_id = $incruste_elements_id;
